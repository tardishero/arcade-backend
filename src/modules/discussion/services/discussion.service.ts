...
export class DiscussionService {
  ...
  async discussionByPage(
    pageNumber: number,
    pageSize: number
  ): Promise<DiscussionListResDto> {
    const [data, total] = await this.discussionRepository
  ...
  async discussionByStuffIdAndPage(
    stuffId: number,
    pageNumber: number,
    pageSize: number
  ): Promise<DiscussionListResDto> {
    const queryBuilder: SelectQueryBuilder<any> = this.discussionRepository
      .createQueryBuilder('discussion')
